...
package org.antlr.v5.test.runtime.dart;
...
public class DartRunner extends RuntimeRunner {
	...
	protected void initRuntime(RunOptions runOptions) throws Exception {
		...
		ST projectTemplate = new ST(RuntimeTestUtils.getTextFromResource("org/antlr/v5/test/runtime/helpers/pubspec.yaml.stg"));
