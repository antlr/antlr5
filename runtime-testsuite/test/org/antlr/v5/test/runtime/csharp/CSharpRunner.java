 ...
 */
package org.antlr.v5.test.runtime.csharp;
...
import static org.antlr.v5.test.runtime.FileUtils.mkdir;
...
public class CSharpRunner extends RuntimeRunner {
	...
	static {
		ST projectTemplate = new ST(RuntimeTestUtils.getTextFromResource("org/antlr/v5/test/runtime/helpers/Antlr4.Test.csproj.stg"));
