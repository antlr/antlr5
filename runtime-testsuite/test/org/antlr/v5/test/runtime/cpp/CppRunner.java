 ...
 */
package org.antlr.v5.test.runtime.cpp;
...
import static org.antlr.v5.test.runtime.RuntimeTestUtils.getOS;
...
public class CppRunner extends RuntimeRunner {
	...
	static {
		...
		if (isWindows()) {
			visualStudioProjectContent = RuntimeTestUtils.getTextFromResource("org/antlr/v5/test/runtime/helpers/Test.vcxproj.stg");
		} else {
