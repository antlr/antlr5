...
public class Antlr5Mojo extends AbstractMojo {
     ...
     */
    @Parameter(property = "antlr5.atn", defaultValue = "false")
	 ...
	 */
	@Parameter(property = "antlr5.listener", defaultValue = "true")
	protected boolean listener;

	/**
	 * Generate parse tree visitor interface and base class.
	 */
	@Parameter(property = "antlr5.visitor", defaultValue = "false")
	protected boolean visitor;

	/**
	 * Treat warnings as errors.
	 */
	@Parameter(property = "antlr5.treatWarningsAsErrors", defaultValue = "false")
	protected boolean treatWarningsAsErrors;

	/**
	 * Use the ATN simulator for all predictions.
	 */
	@Parameter(property = "antlr5.forceATN", defaultValue = "false")
	 ...
	 * {@code test} scope.
	 */
	@Parameter(property = "antlr5.generateTestSources", defaultValue = "false")
	private boolean generateTestSources;

    /**
     * The directory where the ANTLR grammar files ({@code *.g4}) are located.
     */
	@Parameter(defaultValue = "${basedir}/src/main/antlr5")
    private File sourceDirectory;

    /**
     * Specify output directory where the Java files are generated.
     */
	@Parameter(defaultValue = "${project.build.directory}/generated-sources/antlr5")
    private File outputDirectory;

    /**
     * Specify location of imported grammars and tokens files.
     */
	@Parameter(defaultValue = "${basedir}/src/main/antlr5/imports")
    private File libDirectory;

    /**
     * The directory where build status information is located.
     */
    @Parameter(defaultValue = "${project.build.directory}/maven-status/antlr5", readonly=true)
    ...
    public void execute() throws MojoExecutionException, MojoFailureException {
		...
		log.info("ANTLR 5: Processing source directory " + sourceDirectory.getAbsolutePath());
	...
	private final class CustomTool extends Tool {
		...
		public CustomTool(String[] args) {
			super(args);
			addListener(new Antlr5ErrorLog(this, buildContext, getLog()));
		}
