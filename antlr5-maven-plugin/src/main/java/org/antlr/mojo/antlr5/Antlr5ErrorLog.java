 ...
 * @author Sam Harwell
 */
public class Antlr5ErrorLog implements ANTLRToolListener {
    ...
    /**
     * Creates an instance of {@link Antlr5ErrorLog}.
     *
     * @param log The Maven log
     */
    public Antlr5ErrorLog(Tool tool, BuildContext buildContext, Log log) {
        this.tool = tool;
