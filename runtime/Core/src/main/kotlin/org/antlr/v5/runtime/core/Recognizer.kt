...
import org.antlr.v5.runtime.core.jvm.WeakHashMap
...
public abstract class Recognizer<Symbol, ATNInterpreter : ATNSimulator> {
  ...
  private val _listeners = CopyOnWriteArrayList<ANTLRErrorListener>(emptyList())
  ...
  public val tokenTypeMap: Map<String, Int>
    get() {
      val tempVocabulary = vocabulary
        ...
        org.antlr.v5.runtime.core.jvm.synchronized(tokenTypeMapCache) {
  ...
  public val ruleIndexMap: Map<String, Int>
    get() {
      val ruleNames = ruleNames
        ...
        org.antlr.v5.runtime.core.jvm.synchronized(ruleIndexMapCache) {
