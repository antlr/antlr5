...
public abstract class Recognizer<Symbol, ATNInterpreter : ATNSimulator> {
  ...
  public val errorListeners: List<org.antlr.v5.kotlinruntime.ANTLRErrorListener>
    get() = _listeners

  public val errorListenerDispatch: org.antlr.v5.kotlinruntime.ANTLRErrorListener
  ...
  public fun addErrorListener(listener: org.antlr.v5.kotlinruntime.ANTLRErrorListener) {
    _listeners.add(listener)
  }

  public fun removeErrorListener(listener: org.antlr.v5.kotlinruntime.ANTLRErrorListener) {
