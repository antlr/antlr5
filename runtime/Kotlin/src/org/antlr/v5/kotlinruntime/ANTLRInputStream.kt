...
public open class ANTLRInputStream : org.antlr.v5.kotlinruntime.CharStream {
  ...
  override fun LA(i: Int): Int {
    ...
    if (ii < 0) {
      ...
      if (p + ii - 1 < 0) {
        ...
        return org.antlr.v5.kotlinruntime.IntStream.Companion.EOF
      }
    }

    return if (p + ii - 1 >= n) {
        org.antlr.v5.kotlinruntime.IntStream.Companion.EOF
    } else {
      data[p + ii - 1].code
    }
  }
