...
import org.antlr.v5.kotlinruntime.misc.MultiMap
import org.antlr.v5.kotlinruntime.misc.ParseCancellationException
  ...
  public fun tokenize(pattern: String): List<Token> {
    ...
    for (chunk in chunks) {
      if (chunk is TagChunk) {
        ...
        val stream = org.antlr.v5.kotlinruntime.ANTLRInputStream(textChunk.text)
