...
import org.antlr.v5.runtime.kotlin._unused.misc.MultiMap
...
import org.antlr.v5.runtime.kotlin.BailErrorStrategy
import org.antlr.v5.runtime.kotlin.CharStreams
import org.antlr.v5.runtime.kotlin.ListTokenSource
    ...
    for (chunk in chunks) {
      if (chunk is TagChunk) {
        ...
        val textChunk = chunk as TextChunk
         ...
         val stream = CharStreams.fromString(textChunk.text)
