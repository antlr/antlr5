...
import org.antlr.v5.runtime.kotlin.Collections
import org.antlr.v5.runtime.kotlin.Recognizer
import org.antlr.v5.runtime.kotlin.RuleContext
import org.antlr.v5.runtime.kotlin.atn.SemanticContext.*
...
public abstract class SemanticContext {
  ...
  public class AND(a: SemanticContext, b: SemanticContext) : Operator() {
    ...
    override fun hashCode(): Int {
      ...
      val fqn = "org.antlr.v5.kotlinruntime.atn.SemanticContext.AND"
  ...
  public class OR(a: SemanticContext, b: SemanticContext) : Operator() {
    ...
    override fun hashCode(): Int {
      // Note(Edoardo): K/JS KClass.hashCode uses only the class simple name
      //   On the JVM and on Native, the fqn param is ignored
      val fqn = "org.antlr.v5.kotlinruntime.atn.SemanticContext.OR"
